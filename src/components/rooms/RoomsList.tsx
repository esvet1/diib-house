      ...
      <section className="py-20">
        <div className="container-custom">
          <div className="text-center">
            <p className="text-stone-500">Odalar yükleniyor...</p>
          </div>
        </div>
      </section>
    )
              ...
              <div className={`${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link
                    ...
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-stone-800 text-white font-medium rounded-xl hover:bg-stone-700 transition-all duration-300"
                  >
                    Detayları Gör
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#25D366] text-white font-medium rounded-xl hover:bg-[#128C7E] transition-all duration-300"
                  >
