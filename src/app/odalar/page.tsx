...
export const metadata: Metadata = {
  title: 'Odalarımız',
  description: 'Diib House butik otelimizin tarihi atmosferi ve modern konforu birleştiren odalarını keşfedin. VIP çift kişilik odalar ve aile odaları.',
  openGraph: {
    title: 'Odalarımız | Diib House',
    description: 'Diib House butik otelimizin tarihi atmosferi ve modern konforu birleştiren odalarını keşfedin.',
  },
}
        ...
        <div className="container-custom">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="font-serif text-3xl text-white mb-4">
              Rezervasyon Yaptırmaya Hazır mısınız?
            </h2>
